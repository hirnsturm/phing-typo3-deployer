...
## [2.4.0] - 2020-12-30
### Added
- [Task] Remove unneeded requirement 'composer-plugin-api'
- [Task] Use always system composer as default

## [2.3.0] - 2020-11-02
### Added
- [Task] Improve 'git export'
- [Test] Add test environmen

### Changed
- [Task] Make Compose 2.0 compatible

### Removed
- [Remove] Remove composer.lock
- [CI][Remove] Disable travis-ci
...
## [2.2.2] - 2019-11-14
### Add
- [Task] Shows value of composer.no-dev in environment information
### Fixed
- [Bugfix] Composer dev dependencies with missing composer.no-dev

## [2.2.1] - 2019-11-14
### Changed
- [Improvement] Remove of a missing file has not cause an error

## [2.2.0] - 2019-11-14
### Add
- [Task] En-/Disables composer --no-dev by environment

## [2.1.2] - 2019-11-08
### Add
- [Task] Release fails if 'next' does not exist (thanks to pipaltree)
